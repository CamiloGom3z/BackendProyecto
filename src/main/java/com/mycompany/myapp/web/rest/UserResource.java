...
public class UserResource {
    ...
    @PreAuthorize("hasAuthority(\"" + AuthoritiesConstants.ADMIN + "\")")
    public ResponseEntity<Void> activateUser(@PathVariable Long id, @RequestParam boolean activated) {
    ...
    public ResponseEntity<Void> deleteUser(@PathVariable Long id) {
        ...
        if (!userDeleted) {
            return ResponseEntity.notFound().build(); // Usuario no encontrado, devuelve 404
        }
