...
import { sampleWithRequiredData } from '../categoria-producto.test-samples';
...
describe('CategoriaProducto Management Component', () => {
  ...
  describe('trackId', () => {
    it('Should forward to categoriaProductoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCategoriaProductoIdentifier');
      const id = comp.trackId(entity);
      expect(service.getCategoriaProductoIdentifier).toHaveBeenCalledWith(entity);
