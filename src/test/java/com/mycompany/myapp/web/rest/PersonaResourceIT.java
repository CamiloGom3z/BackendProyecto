...
class PersonaResourceIT {
    ...
    public static Persona createEntity() {
        return new Persona().nombre(DEFAULT_NOMBRE).apellido(DEFAULT_APELLIDO).urlImg(DEFAULT_URL_IMG).userId(DEFAULT_USER_ID);
    }
    ...
    public static Persona createUpdatedEntity() {
        return new Persona().nombre(UPDATED_NOMBRE).apellido(UPDATED_APELLIDO).urlImg(UPDATED_URL_IMG).userId(UPDATED_USER_ID);
    }
    ...
    void putExistingPersona() throws Exception {
        ...
        updatedPersona.nombre(UPDATED_NOMBRE).apellido(UPDATED_APELLIDO).urlImg(UPDATED_URL_IMG).userId(UPDATED_USER_ID);
    ...
    void partialUpdatePersonaWithPatch() throws Exception {
        ...
        partialUpdatedPersona.userId(UPDATED_USER_ID);
    ...
    void fullUpdatePersonaWithPatch() throws Exception {
        ...
        partialUpdatedPersona.nombre(UPDATED_NOMBRE).apellido(UPDATED_APELLIDO).urlImg(UPDATED_URL_IMG).userId(UPDATED_USER_ID);
