...
public class EmpleadoTestSamples {
    ...
    public static Empleado getEmpleadoSample1() {
        return new Empleado().id(1L).nombre("nombre1").apellido("apellido1").cargo("cargo1").establecimientoId(1L);
    }

    public static Empleado getEmpleadoSample2() {
        return new Empleado().id(2L).nombre("nombre2").apellido("apellido2").cargo("cargo2").establecimientoId(2L);
    }
