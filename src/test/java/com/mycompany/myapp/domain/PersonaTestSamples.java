...
public class PersonaTestSamples {
    ...
    public static Persona getPersonaSample1() {
        return new Persona().id(1L).nombre("nombre1").apellido("apellido1").urlImg("urlImg1").userId(1L);
    }

    public static Persona getPersonaSample2() {
        return new Persona().id(2L).nombre("nombre2").apellido("apellido2").urlImg("urlImg2").userId(2L);
    }
